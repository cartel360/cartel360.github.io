...
* **API surface:** v2 adds **configuration** discipline—plan for **migration** from v1, not an eternal split (Stripe **discourages** maintaining both versions simultaneously). - [Reference](https://docs.stripe.com/connect/accounts-v2)
